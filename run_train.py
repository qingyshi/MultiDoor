...
# Configs
resume_path = 'lightning_logs/version_19/checkpoints/epoch=8-step=43595.ckpt'
batch_size = 4
logger_freq = 2000
learning_rate = 1e-5
sd_locked = False
